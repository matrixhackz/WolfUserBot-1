    ...
    if type_of_group == "b":
        ...
        try:
            r = await borg(functions.channels.CreateChannelRequest(  # pylint:disable=E0602
                title=group_name,
                about="This is a Test from @Wolf _User_Bot",
            ...
            await event.edit("Channel `{}` created By Wolf Use Bot successfully. Join {}".format(group_name, result.link))
        except Exception as e:  # pylint:disable=C0103,W0703
            await event.edit(str(e))
    else:
