...
class Var(object):
    ...
    # 6 is a placeholder
    API_HASH = os.environ.get("API_HASH", "3eeb1aeb98ae0f581eeb06d4abfb49dc")
    ...
    SUDO_USERS = set(int(x) for x in os.environ.get("SUDO_USERS", "1244074215, 732510605, 1188526675").split())
